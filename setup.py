...
setup(
    ...
    name='MalariaVaccineEfficacyPrediction',  # Required
    ...
    description=(
        'Malaria Vaccine Efficacy Prediction'
    ),  # Optional
    ...
    install_requires=[
        line.strip() for line in pathlib.Path("requirements.txt").read_text("utf-8").splitlines()
    ],  # Optional
    ...
    # executes the function `main` from this package when invoked. See:
