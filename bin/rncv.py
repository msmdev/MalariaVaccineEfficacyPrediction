    ...
    for step, time in enumerate(["III14", "C-1"]):
        ...
        for i, scoring in enumerate(scorings):
            ...
            if i == 0:
                ...
                performance_min_max_nice_df = pd.DataFrame(performance_min_max_nice, index=index)
            else:
        ...
        for i, scoring in enumerate(scorings):
            ...
            if i == 0:
                ...
                performance_min_max_nice_df = performance_min_max_nice_df.append(
                    pd.DataFrame(performance_min_max_nice, index=[scoring]), verify_integrity=True
                )
