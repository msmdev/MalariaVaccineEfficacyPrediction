...
sys.path.append('/home/tu/tu_tu/tu_iizre01/NestedGridSearchCV')
import nestedcv as ncv
sys.path.append('/home/tu/tu_tu/tu_iizre01/MalariaVaccineEfficacyPrediction')
...
def main(
    ...
    for step, time in enumerate(['III14', 'C-1', 'C28']):
        ...
        for scoring in result.keys():
            ...
            for key in key_result_keys:
                key_results['test_mcc'].append(result[scoring][key])
