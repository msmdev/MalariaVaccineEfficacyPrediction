...
maindir='/home/breuter/MalariaVaccineEfficacyPrediction/results/SVM'
...
for dataset in 'whole' 'selective'; do
    ...
    cp /home/breuter/MalariaVaccineEfficacyPrediction/bin/rncv_SVM.py . || { echo "cp /home/breuter/MalariaVaccineEfficacyPrediction/bin/rncv_SVM.py . failed"; exit 1; }
